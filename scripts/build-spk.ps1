...
Copy-Item "$root\synology\icons\manager-256.png" "$stage\PACKAGE_ICON_256.PNG"
...
Copy-Item "$root\synology\ui\config.define" "$stage\ui\config.define"
...
Copy-Item "$root\synology\icons\console-72.png" "$stage\ui\images\console_72.png"
Copy-Item "$root\synology\icons\console-256.png" "$stage\ui\images\console_256.png"
